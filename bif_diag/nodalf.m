function f=nodalf(p,u) % calculation of the pointwise component of the PDE; 
% Extraction and definition of model parameters
...
% Defining and locating pointwise components of the PDE

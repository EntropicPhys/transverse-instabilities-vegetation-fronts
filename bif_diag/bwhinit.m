function p=bwhinit(p,lx,nx,par,b0,w0,h0,dir)
...
p.fuha.outfu=@sgbra; pde=stanpdeo1D(lx,2*lx/nx); p.pdeo=pde; p.vol=2*lx;
...
p.plot.bpcmp=2; p.plot.cl={'black','blue','red'}; plotsol(p);
